...
export default function Home() {
  ...
  const formSchema = z.object({
    ...
    length: z
      ...
      .max(24, "maximum character reached"),
  });
  ...
  const passStrengthMeter = (pass: string) => {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div
                className={cn(
                  ...
                  passStrengthMeter(password) === "Strong"
                    ? "text-primary"
                    : passStrengthMeter(password) === "Medium"
                    ? "text-yellow-500"
                    : "text-destructive",
                )}
              >{`This is a ${passStrengthMeter(password)} password.`}</div>
              <Button
                variant={"default"}
                type="submit"
